...
from active_panoptic_mapping_core.panoptic_segmentation import (
    build_predictor,
...
from active_panoptic_mapping_core.panoptic_segmentation.visualization import (
    colorize_panoptic_segmentation,
)
...
class PanopticSegmentationNode:
    ...
    def input_image_and_gt_segmentation_cb(
        ...
        for id in np.unique(gt_pano_seg):
            ...
            if (
                category_id == NYU40_IGNORE_LABEL
                or category_id not in SCANNET_NYU40_EVALUATION_CLASSES
            ):
