#ifndef ACTIVE_PANOPTIC_MAPPING_PLANNER_PANOPTIC_Mmapper__
#define ACTIVE_PANOPTIC_MAPPING_PLANNER_PANOPTIC_Mmapper__
...
#endif  // ACTIVE_CHANGE_DETECTION_PLANNER_PANOPTIC_Mmapper__
