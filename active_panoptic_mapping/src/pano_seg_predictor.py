...
class PanopticSegmentationNode:
    def __init__(self):
        ...
        predictor_type, model_dir_path = read_predictor_params_from_ros()

        # Instantiate predictor
        self.predictor = PredictorFactory.get_predictor(predictor_type, model_dir_path)
