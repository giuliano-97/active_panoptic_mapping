...
def colorize_panoptic_labels(panoptic_labels):
    ...
    for semantic_value in unique_semantic_values:
        ...
        if (
            ...
            colors[semantic_mask] = NYU40_COLOR_PALETTE[semantic_value]
            used_colors[semantic_value].add(tuple(NYU40_COLOR_PALETTE[semantic_value]))
            ...
            for instance_value in unique_instance_values:
                ...
                random_color = perturb_color(
                    NYU40_COLOR_PALETTE[semantic_value],
                    60,
